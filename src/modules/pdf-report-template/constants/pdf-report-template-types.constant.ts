...
export const PDF_REPORT_TEMPLATE_TYPES = [
  ...
  'accounts_biling',
  'accounts_biling_ipd',
  'accounts_biling_referrals',
  'referral_invoice',
  'wallet_transaction_bill',
  // ── Lab ──
  'lab_report',
  'lab_report_manual_fill',
  'lab_panel',
  'lab_all_report',
  'lab_all_report_with_letterhead',
  'order_print',
  'order_envelope_print',
  ...
  'visit_note_print_external_refer_to',
  'visit_note_medical_certificate',
  'echocardiography_certificate',
  'ekg_ecg_certificate',
  'ultrasound_certificate',
  'patient_discharge',
  'patient_diet_chart',
  'diet_chart_report',
  // ── Blood Bank ──
...
> = {
  ...
  accounts_biling_ipd: 'Accounts Billing - IPD',
  accounts_biling_referrals: 'Accounts Billing - Referrals',
  referral_invoice: 'Referral Invoice',
  wallet_transaction_bill: 'Wallet Transaction Bill',
  // Lab
  lab_report: 'Lab Test Report',
  lab_report_manual_fill: 'Lab Report Manual Fill',
  ...
  order_envelope_print: 'Order Envelope Print',
  order_print_without_bill: 'Lab Order (Without Bill)',
  order_phlebo_detail: 'Order Phlebo Detail Print',
  ...
  order_barcode_print: 'Order Barcode',
  ...
  visit_note_print_external_refer_to: 'Visit Note, External Refer To',
  visit_note_medical_certificate: 'Visit Note, Medical Certificate',
  echocardiography_certificate: 'Visit Note, Echocardiography Certificate',
  ekg_ecg_certificate: 'Visit Note, EKG/ECG Certificate',
  ultrasound_certificate: 'Visit Note, Ultrasound Certificate',
  patient_discharge: 'Patient Discharge Slip',
  patient_diet_chart: 'Patient Diet Chart',
  diet_chart_report: 'Diet Chart Report',
  // Blood Bank
  blood_donation_complete_label: 'Blood Donation Label',
  blood_request_cross_match: 'Blood Request Cross Match',
  // Other
  duty_roster_report: 'Duty Roster Report',
  pharmacy_sales_invoice_print: 'Pharmacy Sales Invoice',
