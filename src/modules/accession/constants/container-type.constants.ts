...
export const CONTAINER_TYPE_LABELS: Record<ContainerType, string> = {
  ...
  URINE_24H_CONTAINER_NO_PRESERVATIVE: '24-Hour Urine Container (No Preservative)',
  URINE_24H_CONTAINER_ACETIC_ACID: '24-Hour Urine Container with 50% Acetic Acid',
  URINE_24H_CONTAINER_HYDROCHLORIC_ACID: '24-Hour Urine Container with 6M Hydrochloric Acid',
  URINE_24H_CONTAINER_BORIC_ACID: '24-Hour Urine Container with Boric Acid',
  URINE_24H_CONTAINER_DIAZOLIDINYL_UREA: '24-Hour Urine Container with Diazolidinyl Urea (Germall)',
  URINE_24H_CONTAINER_SODIUM_CARBONATE: '24-Hour Urine Container with Sodium Carbonate',
  ...
  GLASS_SLIDES_WITH_FIXATIVE_SLIDE_JAR: 'Glass Slides with Fixative / Slide Jar',
  ...
  PPT_PLASMA_PREP_TUBE_PEARL_WHITE_TOP: 'PPT (Plasma Preparation Tube - Pearl White Top)',
  ...
  SODIUM_CITRATE_TUBE_32PCT_LIGHT_BLUE_TOP: 'Sodium Citrate Tube 3.2% (Light Blue Top)',
  SODIUM_CITRATE_TUBE_38PCT_ESR_BLACK_TOP: 'Sodium Citrate Tube 3.8% for ESR (Black Top)',
  SODIUM_FLUORIDE_OXALATE_TUBE_GREY_TOP: 'Sodium Fluoride / Potassium Oxalate Tube (Grey Top)',
  SODIUM_HEPARIN_TUBE_GREEN_TOP: 'Sodium Heparin Tube (Green Top)',
  STERILE_CONTAINER_NEUTRAL_BUFFERED_FORMALIN: 'Sterile Container with 10% Neutral Buffered Formalin',
  STERILE_CONTAINER_GLUTARALDEHYDE: 'Sterile Container with 2.5% Glutaraldehyde',
  STERILE_CONTAINER_CARY_BLAIR_MEDIUM: 'Sterile Container with Cary-Blair Transport Medium',
  STERILE_CONTAINER_MICHELS_ZEUS_MEDIUM: "Sterile Container with Michel's / ZEUS Transport Medium",
  STERILE_CONTAINER_NORMAL_SALINE_FRESH: 'Sterile Container with Normal Saline / Fresh',
  STERILE_DRY_SWAB_CONTAINER: 'Sterile Dry Swab Container (No Preservative)',
  STERILE_UNIVERSAL_WIDE_MOUTH_CONTAINER: 'Sterile Universal Wide-Mouth Container',
  SWEAT_COLLECTION_DEVICE_MACRODUCT: 'Sweat Collection Device (Macroduct)',
  SWAB_TUBE_AMIES_STUART_MEDIUM: 'Swab Tube with Transport Medium (Amies / Stuart)',
  SWAB_TUBE_VIRAL_TRANSPORT_MEDIUM: 'Swab Tube with Viral Transport Medium (VTM)',
