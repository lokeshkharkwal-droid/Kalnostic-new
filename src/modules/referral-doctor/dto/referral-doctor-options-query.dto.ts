...
/**
 * Query DTO for the lightweight `GET /referral-doctors/options` endpoint (id +
 * name only), used by searchable, paginated selectors. All fields are optional:
 *
 * - `search` — case-insensitive match against the referral doctor `firstName`.
 ...
 */
export class ReferralDoctorOptionsQueryDto extends PaginationQueryDto {
  @IsOptional()
  @IsString()
  @MaxLength(100)
  search?: string;
