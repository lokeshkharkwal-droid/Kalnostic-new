 ...
 * category/department, and BranchModule to verify a client-supplied `branchId`
 * belongs to the tenant — all via their exported services (CLAUDE.md rule #3 —
 * never import another service directly).
 */
@Module({
  imports: [PrismaModule, CategoryModule, DepartmentModule, BranchModule],
