...
-- CreateEnum
CREATE TYPE "AuditModule" AS ENUM ('USER', 'BRANCH', 'SCHEDULE', 'TENANT', 'DEPARTMENT', 'CATEGORY', 'SUB_CATEGORY', 'MASTER_DATA', 'LAB_TEST', 'LAB_PANEL', 'OUTSOURCE_CENTER', 'DOCTOR', 'REFERRAL_PANEL', 'REFERRAL_PANEL_SETTINGS', 'REFERRAL_DOCTOR', 'EXTERNAL_REFERRAL', 'INTERNAL_REFERRAL', 'MACHINE', 'DOCUMENT', 'TEMPLATE', 'PDF_REPORT_TEMPLATE', 'PATIENT', 'PATIENT_CATEGORY', 'MEDICAL_HISTORY', 'ORDER', 'RADIOLOGIST', 'PHLEBOTOMIST', 'RADIOLOGY_TECHNICIAN', 'PAYMENT_DETAILS', 'APPOINTMENT', 'DOCTOR_SCHEDULE', 'PHLEBOTOMIST_SCHEDULE', 'SERVICE_ZONE', 'AUTH', 'SITEADMIN', 'EQUIPMENT', 'CONTACT_US', 'SUPPORT_INFO', 'AUTH_ROLE', 'TEST_GROUP', 'PAYMENT_RULE', 'LOCATION', 'LAB_TEST_SETTINGS', 'BILLING_SETTINGS', 'ACCESSION', 'PATIENT_SETTINGS', 'CONSOLE_SETTINGS', 'REPORT_SETTINGS', 'PHLEBOTOMIST_SETTINGS', 'LAB_REPORT', 'RE_RUN_REQUEST', 'CRITICAL_ALERT', 'OUT_OF_RANGE_FLAG', 'DELTA_CHECK', 'SCHEDULED_TEST', 'INVENTORY_USAGE', 'MULTI_STEP_PROCESS', 'LAB_ADAPTER', 'SALES_LEAD', 'SALES_TRIP', 'SALES_FOLLOW_UP', 'SALES_TERRITORY', 'SALES_SETTINGS', 'REGISTRATION_SETTINGS');
...
-- CreateTable
CREATE TABLE "siteadmin_audit_logs" (
    "id" TEXT NOT NULL,
    "module" "AuditModule" NOT NULL,
    "action" "AuditAction" NOT NULL DEFAULT 'OTHER',
    "description" TEXT NOT NULL,
    "actor_siteadmin_id" TEXT NOT NULL,
    "actor_email" TEXT NOT NULL,
    "actor_role" "SiteAdminRole" NOT NULL,
    "ip_address" TEXT,
    "resource_id" TEXT,
    "metadata" JSONB,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "siteadmin_audit_logs_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "registration_settings" (
    ...
    "charges_and_deductions_allow_order_without_clearing_previous_du" BOOLEAN NOT NULL DEFAULT false,
    ...
    "charges_and_deductions_allow_partial_billing_of_discounted_orde" BOOLEAN NOT NULL DEFAULT false,
    ...
    "referral_and_staff_permissions_allow_add_radiology_technician_n" BOOLEAN NOT NULL DEFAULT true,
    ...
    "appointment_allow_progress_of_unpaid_and_partial_paid_appointme" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "accession_settings" (
    ...
    "branch_id" TEXT NOT NULL,
    "config" JSONB NOT NULL DEFAULT '{}',
    "sample_barcode_settings_prefix" VARCHAR(24) NOT NULL DEFAULT '',
    "sample_barcode_settings_suffix" VARCHAR(24) NOT NULL DEFAULT '',
    "sample_barcode_settings_separator" "AccessionBarcodeSeparator" NOT NULL DEFAULT 'NONE',
    "sample_barcode_settings_number_length" INTEGER NOT NULL DEFAULT 6,
    "sample_barcode_settings_reset_interval" "AccessionBarcodeResetCycle" NOT NULL DEFAULT 'NEVER',
    "sample_barcode_settings_current_number" INTEGER NOT NULL DEFAULT 0,
    "sample_barcode_settings_last_reset_at" TIMESTAMP(3),
    "accession_min_time_to_accept_sample_minutes" INTEGER NOT NULL DEFAULT 10,
    "accession_max_time_to_accept_sample_minutes" INTEGER NOT NULL DEFAULT 20,
    "accession_warning_threshold_minutes" INTEGER NOT NULL DEFAULT 10,
    "accession_critical_threshold_minutes" INTEGER NOT NULL DEFAULT 5,
    "accession_internal_referral_acceptance_threshold_minutes" INTEGER NOT NULL DEFAULT 60,
    "accession_external_referral_acceptance_threshold_minutes" INTEGER NOT NULL DEFAULT 60,
    "accession_allow_mapping_before_accept_inhouse" BOOLEAN NOT NULL DEFAULT true,
    "accession_allow_mapping_before_accept_internal_referral" BOOLEAN NOT NULL DEFAULT true,
    "accession_allow_mapping_before_accept_external_referral" BOOLEAN NOT NULL DEFAULT true,
    "accession_allow_mapping_after_accept_inhouse" BOOLEAN NOT NULL DEFAULT true,
    "accession_allow_mapping_after_accept_internal_referral" BOOLEAN NOT NULL DEFAULT true,
    "accession_allow_mapping_after_accept_external_referral" BOOLEAN NOT NULL DEFAULT true,
    "accession_allow_mapping_for_outsource" BOOLEAN NOT NULL DEFAULT true,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "deleted_at" TIMESTAMP(3),
...
-- CreateIndex
CREATE INDEX "siteadmin_audit_logs_actor_siteadmin_id_idx" ON "siteadmin_audit_logs"("actor_siteadmin_id");

-- CreateIndex
CREATE INDEX "siteadmin_audit_logs_module_idx" ON "siteadmin_audit_logs"("module");

-- CreateIndex
CREATE INDEX "siteadmin_audit_logs_created_at_idx" ON "siteadmin_audit_logs"("created_at");

-- CreateIndex
CREATE INDEX "siteadmin_audit_logs_deleted_at_idx" ON "siteadmin_audit_logs"("deleted_at");
...
-- CreateIndex
CREATE INDEX "internal_referrals_department_id_idx" ON "internal_referrals"("department_id");
...
-- AddForeignKey
ALTER TABLE "internal_referrals" ADD CONSTRAINT "internal_referrals_department_id_fkey" FOREIGN KEY ("department_id") REFERENCES "departments"("id") ON DELETE SET NULL ON UPDATE CASCADE;
